          ...
          <div className="flex-1 max-w-[837px]">
            ...
            <FadeIn delay={0.2}>
              <h1 className="text-black text-[28px] md:text-[36px] lg:text-[48px] font-inter font-bold leading-tight mb-8 md:mb-12 tracking-[-0.84px] md:tracking-[-1.44px]">
                O que você não mede, você repete. E o que mede errado, você corrige errado.
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <div className="text-[#615F5F] text-[15px] md:text-[16px] lg:text-[18px] font-inter leading-[1.7] space-y-6">
                <p>
                  Em quase toda empresa que fatura bem, mas não cresce, tem um padrão invisível acontecendo: as decisões são tomadas no feeling. Não é porque falta dado — é porque os dados estão soltos, mal organizados ou simplesmente não dizem nada útil.
                </p>
                <p>
                  É aquela planilha que ninguém abre. Aquele painel bonito, mas genérico. Ou o clássico: "os leads caíram esse mês, mas ninguém sabe por quê."
                </p>
                <p>
                  Na Loopscale, dados são uma ferramenta de gestão, não de enfeite. Eles guiam o marketing, alinham o comercial, mostram onde o cliente trava e onde o dinheiro está escapando.
                </p>
              </div>
            </FadeIn>
          </div>
